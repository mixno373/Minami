...
conn = create_connection(r"YtComments-pine.db")
...
while True:
    for i, comment in enumerate(yt_c_client.get_comments_by_channel_id('UCnqkK1BWd0S4_nFgBmpEmBA'), 1):
        # if i == 100:
        #     break
        print(comment)
